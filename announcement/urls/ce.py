...
router.register('announcements', AnnouncementViewSet, basename='all_announcements')
router.register('bulk_messages', BulkMessageViewSet, basename='all_bulk_messages')
router.register('bulk_message_logs', BulkMessageLogViewSet, basename='all_bulk_message_logs')
router.register('bulk_messages_recipients', BulkMessageRecipientViewSet, basename='all_bulk_messages_recipients')
